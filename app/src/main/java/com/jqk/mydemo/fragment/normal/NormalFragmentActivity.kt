...
import com.jqk.mydemo.databinding.ActivityFragmentNormalBinding
...
class NormalFragmentActivity : AppCompatActivity() {
    ...
    lateinit var b: ActivityFragmentNormalBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b = DataBindingUtil.setContentView(this, R.layout.activity_fragment_normal)
        b.view = this
